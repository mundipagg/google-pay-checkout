...
public class Constants {
   ...
   */
    public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("BR");
  ...
  public static final String PAYMENT_GATEWAY_TOKENIZATION_ID = "04340127075727423478";
