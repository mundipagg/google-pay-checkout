...
import com.mundipagg.googlepay.wallet.models.ItemInfo;
import com.mundipagg.googlepay.wallet.models.PaymentToken;
import com.mundipagg.googlepay.wallet.utils.DialogUtils;
import com.mundipagg.googlepay.wallet.utils.PaymentsUtil;
import com.mundipagg.googlepay.wallet.utils.TokenUtils;
...
public class CheckoutActivity extends Activity {
  ...
  private ItemInfo mBikeItem = new ItemInfo("Simple Bike", 1 * 10000000, R.drawable.bike);
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    Log.d("test_requestCode",  Integer.toString(resultCode));
  ...
  private void handlePaymentSuccess(PaymentData paymentData) {
    ...
    try {
      ...
      PaymentToken token = TokenUtils.BuildTokenObject(this, paymentMethodData);

      Log.d("GooglePaymentToken", paymentMethodData.getJSONObject("tokenizationData").getString("token"));

      CheckoutTokenSender sender = new CheckoutTokenSender(this);
  ...
  private void handleError(int statusCode) {
    DialogUtils.alert(this, "Error", String.format("Error code: %d", statusCode));
