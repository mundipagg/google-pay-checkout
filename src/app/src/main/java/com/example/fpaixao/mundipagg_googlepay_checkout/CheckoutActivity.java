...
import com.example.fpaixao.mundipagg_googlepay_checkout.models.ItemInfo;
import com.example.fpaixao.mundipagg_googlepay_checkout.models.PaymentToken;
import com.example.fpaixao.mundipagg_googlepay_checkout.utils.PaymentsUtil;
import com.example.fpaixao.mundipagg_googlepay_checkout.utils.TokenUtils;
...
public class CheckoutActivity extends Activity {
  ...
  private void handlePaymentSuccess(PaymentData paymentData) {
    ...
    try {
      ...
      PaymentToken token = TokenUtils.BuildTokenObject(paymentMethodData);
      new CheckoutTokenSender(this).SendToken(token);
